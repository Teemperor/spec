...
(module
    ...
    (func $no_dce.i32.load (param $i i32) (i32.load (i32.add (page_size) (get_local $i))))
    (export "no_dce.i64.load" $no_dce.i64.load)
    (func $no_dce.i64.load (param $i i32) (i64.load (i32.add (page_size) (get_local $i))))
    (export "no_dce.f32.load" $no_dce.f32.load)
    (func $no_dce.f32.load (param $i i32) (f32.load (i32.add (page_size) (get_local $i))))
    (export "no_dce.f64.load" $no_dce.f64.load)
    (func $no_dce.f64.load (param $i i32) (f64.load (i32.add (page_size) (get_local $i))))
)

(assert_trap (invoke "no_dce.i32.load" (i32.const 0)) "runtime: out of bounds memory access")
(assert_trap (invoke "no_dce.i64.load" (i32.const 0)) "runtime: out of bounds memory access")
(assert_trap (invoke "no_dce.f32.load" (i32.const 0)) "runtime: out of bounds memory access")
(assert_trap (invoke "no_dce.f64.load" (i32.const 0)) "runtime: out of bounds memory access")
